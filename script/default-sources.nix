...

{
  ...
  sptlSrc = pkgs.fetchFromGitHub {
    owner  = "deepsea-inria";
    repo   = "sptl";
    rev    = "b97fc37bd6c2f8997466a1d01fdb4d8332f0d01c";
    sha256 = "1lmdvpppnja5wvc6s9kggfxs749fi8fb6xjc9bgkarpx4pnzq9j1";
  };
  ...
  pbbsSptlSrc = pkgs.fetchFromGitHub {
    owner  = "deepsea-inria";
    repo   = "pbbs-sptl";
    rev    = "b47e1d5ccf93f7933cfacfb4e1cfb0c8fe3bcf3f";
    sha256 = "10b9j5yg5178wqws9b6vghvn942c0m969962nnc9mjj265fn9jwn";
  };
